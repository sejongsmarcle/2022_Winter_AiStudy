...
## 목차
1. [Ⅰ. 데이터 조작](#데이터-조작)
     - [ⅰ. 데이터 스케일링](1.데이터-스케일링)
     - [ⅱ. validation 데이터 교차 검증화(Cross-validation)](2.validation-데이터-교차-검증화(Cross-validation))
     - [ⅲ. 튀는 데이터 살펴보기](3.튀는-데이터-살펴보기)
...
### 2. validation 데이터 교차 검증화(Cross-validation)
